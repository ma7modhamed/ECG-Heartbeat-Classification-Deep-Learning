...
namespace GP
{
    public static class Helper
    {
        ...
        {
            //MessageBox.Show(pythonInterpreter);
        ...
        public static void DrawBeats(FlowLayoutPanel flow, int numOfBeats, int distanceBetweenBeats)
        {
            ...
            for (int l = 0; l < numOfBeats; l++)
            {
                ...
                chart.Series[0].Color = Color.FromArgb(255,154,118);
        ...
        public static void DrawSignal(Chart chart, List<double>signal,int signalLength)
        {
            chart.Series[0].Points.Clear();
            MakeScrollingChart(chart, 1500,0,1);
            
            for(int i =0;i< signalLength;i++)
            {
                chart.Series[0].Points.AddY(signal[i]);
            }
        }
